...
//
/**
 * Initialize sidebar based on current user stage.
 * @returns {undefined}
 */
...
//
///**
// * - Perform the email/password login in profile section.
// * - First check if user is logged in.
// * - Success : Close login window and load profiles they currently have.
// * - Fail    : Tell user that their account was not found.
// */
//function profile_user_show_login() {
//  var loggedin = user_loggedin();
//  
//  if(!loggedin) {
//    //$("#profile-email-login-dialog-error").hide();
//    $("#profile-email-login-dialog").dialog({
//      resizable: false,
//      width: 400,
//      height: 330,
//      modal: true,
...
//}
//
//function profile_user_login() {
//  var result = user_login_email($("#profile-email-login-email").val(), $("#profile-email-login-password").val());
//  
//  if(result.loggedin === false) {
//    $("#profile-email-login-dialog-error").show();
//    $("#profile-email-login-dialog-error").html(result.message);
//  } else {
//    $("#profile-email-login-dialog").dialog('close');
//    profile_load();
//    sidebar_init();
//  }
//}
//
///**
// * - Load the user's list of profiles.
// * - If they are logged in, then they have at least one.
// */
...
// * - 
// */
//function profile_init(is_logged_in) {
